 ...
 * Use the {@link TinderMainFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TinderMainFragment extends Fragment {
     ...
     * @return A new instance of fragment TinderMainFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TinderMainFragment newInstance(String param1, String param2) {
        TinderMainFragment fragment = new TinderMainFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tinder_main, container, false);
        context = getActivity();
    ...
    private void likeDislike(String status, int pos) {
        // int position=pos-1;
        if (homeList != null && homeList.size() > 0) {
            Home_data homeData = homeList.get(0);
            if (homeData != null) {
    ...
    private void getAllHome() {
        if (Utility.isOnline(getContext())) {
            ...
            try {
                ...
                if(allCountryHome){
                    object.put("city_exclude_id", cityId);
                }else {
                    ...
                    if (serviceData.getData() != null) {
                        new AsyncTask<Void, Void, Boolean>() {
                            ...
                            protected Boolean doInBackground(Void... voids) {
                                total_homespage=serviceData.getTotal_homes();
                                Boolean flag = false;
