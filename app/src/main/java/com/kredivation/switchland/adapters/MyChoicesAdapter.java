...
public class MyChoicesAdapter extends RecyclerView.Adapter<MyChoicesAdapter.MyViewHolder> {
    ...
    public MyChoicesAdapter(Context mContext, ArrayList<MychoiceArray> myHomeList) {
