...
public class HomeDetails {
    ...
    private Home_features[] home_features;
    ...
    public Home_features[] getHome_features ()
    {
        return home_features;
    }

    public void setHome_features (Home_features[] home_features)
    {
        this.home_features = home_features;
    }
    ...
    public Home_rules[] getHome_rules ()
    {
        return home_rules;
    }

    public void setHome_rules (Home_rules[] home_rules)
    {
    ...
    public Homegallery[] getHomegallery ()
    {
        return homegallery;
    }

    public void setHomegallery (Homegallery[] homegallery)
    {
    ...
    ArrayList<Home_rules> houseRuleList;
    ArrayList<Homegallery> homeImageList;

    public ArrayList<Home_features> getFeatureList() {
        return featureList;
    }

    public void setFeatureList(ArrayList<Home_features> featureList) {
        this.featureList = featureList;
    }

    public ArrayList<Home_rules> getHouseRuleList() {
        return houseRuleList;
    }

    public void setHouseRuleList(ArrayList<Home_rules> houseRuleList) {
        this.houseRuleList = houseRuleList;
    }

    public ArrayList<Homegallery> getHomeImageList() {
        return homeImageList;
    }

    public void setHomeImageList(ArrayList<Homegallery> homeImageList) {
    ...
    {
        return "ClassPojo [destinations = "+destinations+", city_name = "+city_name+", profile_completeness = "+profile_completeness+", location = "+location+", home_features = "+home_features+", bathrooms = "+bathrooms+", homestyle = "+homestyle+", address1 = "+address1+", address2 = "+address2+", travellertype = "+travellertype+", country_name = "+country_name+", travelling_anywhere = "+travelling_anywhere+", home_rules = "+home_rules+", religion = "+religion+", id = "+id+", city_id = "+city_id+", sort_description = "+sort_description+", petsallowed = "+petsallowed+", title = "+title+", updated_date = "+updated_date+", family = "+family+", pets = "+pets+", gender = "+gender+", homegallery = "+homegallery+", user_id = "+user_id+", longitude = "+longitude+", added_date = "+added_date+", status = "+status+", profile_image = "+profile_image+", zipcode = "+zipcode+", country_id = "+country_id+", sleeps = "+sleeps+", bedrooms = "+bedrooms+", propertytype = "+propertytype+", property_type = "+property_type+", family_matters = "+family_matters+", startdate = "+startdate+", landmarks = "+landmarks+", level_security = "+level_security+", traveller_type = "+traveller_type+", house_no = "+house_no+", home_type = "+home_type+", latitude = "+latitude+", enddate = "+enddate+"]";
    }
}
