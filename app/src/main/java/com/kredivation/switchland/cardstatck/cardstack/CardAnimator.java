...
import com.kredivation.switchland.cardstatck.animation.RelativeLayoutParamsEvaluator;
...
Context context;
    ...
    public CardAnimator(Context mcontext,ArrayList<View> viewCollection) {
        ...
        for (View v : mCardCollection) {
            ...
            */
            ...
            if (index == 0)// setting 0 used to add different layout shadow...
                v.setBackground(context.getResources().getDrawable(R.drawable.card_stack_bg_shadow3));
            else if (index == 1)
                v.setBackground(context.getResources().getDrawable(R.drawable.card_stack_bg_shadow2));
            else if (index == 2)
                v.setBackground(context.getResources().getDrawable(R.drawable.card_stack_bg_shadow));
        }
    }
